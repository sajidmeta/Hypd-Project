...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="bg-white py-4 w-[90%] m-auto px-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <div className="flex items-center gap-10">
            <span className="font-bold text-orange-500 text-xl">HYPD</span>
          ...
          <div className="flex items-center space-x-4">
            {/* setting icon */}
            <FiSettings className="h-5 w-5 text-gray-600 hover:text-black" />
            {/* Notification Icon */}
        ...
        <div className="bg-gray-50 border-t border-b  border-gray-300 py-3 flex items-center justify-between px-24 ">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-600 text-sm">
              ...
              <span className="text-[#475467]"> Lorem ipsum dolor sit amet </span>
              <a href="#" className=" underline">consectetur</a>.
            </span>
          </div>
